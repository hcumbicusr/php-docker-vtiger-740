...
$HELPDESK_SUPPORT_EMAIL_ID = 'support@email.com';
...
$dbconfig['db_username'] = getenv('MYSQL_USER');
$dbconfig['db_password'] = getenv('MYSQL_PASSWORD');
$dbconfig['db_name'] = getenv('MYSQL_DATABASE');
...
// root directory path
$root_directory = '/var/www/html/vtiger740/';
...
$upload_maxsize = getenv('UPLOAD_MAXSIZE');//3MB
...
$list_max_entries_per_page = getenv('LIST_MAX_ENTRIES_PER_PAGE');
...
$application_unique_key = '8166486d643a2857efb70b6b1a905ae4';
